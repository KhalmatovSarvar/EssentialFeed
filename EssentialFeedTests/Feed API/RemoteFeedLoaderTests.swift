...
class RemoteFeedLoaderTests: XCTestCase {
    ...
    func test_loadTwice_requestsDataFromURLTwice() {
        ...
        // we are testing that single request per method call
        sut.load { _ in } // 1st call
        sut.load { _ in } // 2nd call

        XCTAssertEqual(client.requestedURLs, [url, url]) // thus 2 urls captured
    }
